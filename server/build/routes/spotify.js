...
router.get("/getRandomSong", function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var previewUrl, char, offset, url, config, result, tracks, _i, tracks_1, track, err_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                _a.label = 1;
            case 1:
                if (!!previewUrl) return [3 /*break*/, 7];
            ...
            case 3:
                result = _a.sent();
                return [4 /*yield*/, result.data.tracks.items];
            case 4:
                tracks = _a.sent();
